...
kubectl get svc -n todo-app-list

echo "Waiting for the application to be ready..."
kubectl wait --for=condition=ready pod -l app=todo-webapp -n todo-app-list --timeout=60s
echo "Waiting for mongodb to be available..."
kubectl wait --for=condition=ready pod -l app=mongodb -n todo-app-list --timeout=120s

# Get WebApp NodePort
WEBAPP_PORT=$(kubectl get svc -n todo-app-list \
...
MONGO_EXPRESS_PORT=$(kubectl get svc -n todo-app-list \
